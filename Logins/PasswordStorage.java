...
public class PasswordStorage
{
    ...
    public  final int HASH_BYTE_SIZE = 18;
    public  final int PBKDF2_ITERATIONS = 64000;

    // These constants define the encoding and may not be changed.
    public  final int HASH_SECTIONS = 5;
    public  final int HASH_ALGORITHM_INDEX = 0;
    public  final int ITERATION_INDEX = 1;
    public  final int HASH_SIZE_INDEX = 2;
    public  final int SALT_INDEX = 3;
    public  final int PBKDF2_INDEX = 4;
